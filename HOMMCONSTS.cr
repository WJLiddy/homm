module HOMMCONSTS
    ...
    TIER3_BUILDING_COST_BITCOIN = 30
    TIER3_BUILDING_COST_POT = 0
    TIER3_BUILDING_COST_CEREAL = 6

    # Building Costs (ballista)
    TIER4_BUILDING_COST_BITCOIN = 60
    TIER4_BUILDING_COST_POT = 9
    TIER4_BUILDING_COST_CEREAL = 3

    # Building Costs (wizard)
    TIER5_BUILDING_COST_BITCOIN = 90
    TIER5_BUILDING_COST_POT = 9
